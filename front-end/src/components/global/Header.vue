<template>
  ...
  <div class="header is_stuck">
      ...
      <div class="navbar-header">
        <a class="navbar-brand" href="index.html">
          <router-link to="/" class="navbar-brand invisible-xs" exact>
            <img id="small-logo" src="../../images/logo-small.png" alt="Smarja" />
            <img id="full-logo" src="../../images/logo-full.png" alt="Smarja" />
          </router-link>
        </a>
      </div>
      <!-- End Logo -->
          ...
          >
            ...
            >
              <ul class="dropdown-user">
                <li>
                  <a href="#" v-b-modal.modal-profile>
    ...
    <b-modal
      ...
      :hide-footer="true"
    >
    <ProfileCard :UserID="this.$store.state.app.login.ID"></ProfileCard>
...
export default {
  ...
  methods: {
    ...
    logout() {
      this.SETTOKEN({ name: "", email: "", token: "", claims: "" });

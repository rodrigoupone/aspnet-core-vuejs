...
namespace WebAPI.Controllers
{
    ...
    {
        private readonly Core.Feature.PedidoFeature _feature;

        public PedidoController(Core.Feature.PedidoFeature feature)
        {
            _feature = feature;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Post([FromBody] PedidoModel obj)
        {

...
namespace WebAPI.Controllers
{
    ...
    {
        private readonly Core.Feature.SaborFeature _feature;

        public SaborController(Core.Feature.SaborFeature feature)
        {
            _feature = feature;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Post([FromBody] Sabor obj)
        {
